...
public class GetTopOneHundredFiftyCitiesTest extends AbstractTest{

    private static final Logger logger
            = LoggerFactory.getLogger(GetTopOneHundredFiftyCitiesTest.class);
    ...
    void test200ResponseCode() throws IOException, URISyntaxException {
        ...
        stubFor(WireMock.get(urlPathEqualTo("/locations/v1/topcities/100"))
        ...
        HttpGet get = new HttpGet(getBaseUrl() + "/locations/v1/topcities/100");
        ...
        verify(2, getRequestedFor(urlPathEqualTo("/locations/v1/topcities/100")));
