...
public class GetWeatherTenDaysTest extends AbstractTest{
    ...
    void test401ResponseCode() throws URISyntaxException, IOException {
        ...
        logger.debug("Формирование мока для сервиса GetWeatherTenDaysTest");

        stubFor(WireMock.get(urlPathEqualTo("/forecasts/v1/daily/10day/28580"))
                .withQueryParam("apikey", equalTo( "10"))
                .willReturn(aResponse().withStatus(401).withBody("Error")));

        CloseableHttpClient client = HttpClients.createDefault();
        HttpGet get = new HttpGet(getBaseUrl()+"/forecasts/v1/daily/10day/28580");
        URI uri = new URIBuilder(get.getURI())
                .addParameter("apikey", "10")
                .build();
        get.setURI(uri);
        ...
        verify(getRequestedFor(urlPathEqualTo("/forecasts/v1/daily/10day/28580")));
