...
public class GetIPAddressSearchTest extends AbstractTest {

    private static final Logger logger
            = LoggerFactory.getLogger(GetIPAddressSearchTest.class);
    ...
    void test200ResponseCode() throws IOException, URISyntaxException {
        ...
        stubFor(WireMock.get(urlPathEqualTo("/locations/v1/cities/ipaddress"))
        ...
        HttpGet get = new HttpGet(getBaseUrl()+"/locations/v1/cities/ipaddress");
        ...
        verify(2,getRequestedFor(urlPathEqualTo("/locations/v1/cities/ipaddress")));
