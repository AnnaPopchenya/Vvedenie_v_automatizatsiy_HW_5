...
public class GetCityNeighborsTest  extends AbstractTest{
    ...
    private static final Logger logger
            = LoggerFactory.getLogger(GetCityNeighborsTest.class);
    ...
    void test200ResponseCode() throws IOException, URISyntaxException {
        ...
        stubFor(WireMock.get(urlPathEqualTo("/locations/v1/cities/neighbors/28580"))
        ...
        HttpGet get = new HttpGet(getBaseUrl()+"/locations/v1/cities/neighbors/28580");
        ...
        verify(2,getRequestedFor(urlPathEqualTo("/locations/v1/cities/neighbors/28580")));
