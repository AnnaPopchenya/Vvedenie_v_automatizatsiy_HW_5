...
public class GetTopFiftyCitiesTest extends AbstractTest{
    private static final Logger logger
            = LoggerFactory.getLogger(GetTopFiftyCitiesTest.class);
    ...
    void test200ResponseCode() throws IOException, URISyntaxException {
        ...
        stubFor(WireMock.get(urlPathEqualTo("/locations/v1/topcities/50"))
        ...
        HttpGet get = new HttpGet(getBaseUrl() + "/locations/v1/topcities/50");
        ...
        verify(2, getRequestedFor(urlPathEqualTo("/locations/v1/topcities/50")));
