...
public class GetWeatherTwelveHourTest extends AbstractTest{
    private static final Logger logger
            = LoggerFactory.getLogger(GetWeatherTwelveHourTest.class);
    ...
    void test200ResponseCode() throws IOException, URISyntaxException {
        ...
        stubFor(WireMock.get(urlPathEqualTo("/forecasts/v1/hourly/12hour/28580"))
                .withQueryParam("q", equalTo("12"))
        ...
        HttpGet get = new HttpGet(getBaseUrl() + "/forecasts/v1/hourly/12hour/28580");
        ...
        verify(2, getRequestedFor(urlPathEqualTo("/forecasts/v1/hourly/12hour/28580")));
