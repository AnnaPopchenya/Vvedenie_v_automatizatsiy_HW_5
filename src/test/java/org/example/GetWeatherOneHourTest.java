...
public class GetWeatherOneHourTest extends AbstractTest{
    private static final Logger logger
            = LoggerFactory.getLogger(GetWeatherOneHourTest.class);
    ...
    void test200ResponseCode() throws IOException, URISyntaxException {
        ...
        stubFor(WireMock.get(urlPathEqualTo("/forecasts/v1/hourly/1hour/28580"))
        ...
        HttpGet get = new HttpGet(getBaseUrl() + "/forecasts/v1/hourly/1hour/28580");
        ...
        verify(2, getRequestedFor(urlPathEqualTo("/forecasts/v1/hourly/1hour/28580")));
