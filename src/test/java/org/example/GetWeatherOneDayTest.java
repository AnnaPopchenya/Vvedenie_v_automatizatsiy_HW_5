...
public class GetWeatherOneDayTest extends AbstractTest{
    ...
    void test200ResponseCode() throws IOException, URISyntaxException {
        ...
        stubFor(WireMock.get(urlPathEqualTo("/forecasts/v1/daily/1day/28580"))
        ...
        HttpGet get = new HttpGet(getBaseUrl() + "/forecasts/v1/daily/1day/28580");
        ...
        verify(2, getRequestedFor(urlPathEqualTo("/forecasts/v1/daily/1day/28580")));
